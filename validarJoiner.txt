Sub ValidarJoiner()
    ...
    nombreMacro = "JOINER"
    nombreReporte = "SantanderJoinerEvent"
    ...
    nextRowSheet = sheetMacro.Cells(sheetMacro.Rows.Count, "A").End(xlUp).Row + 1
            ...
            Else
                 ...
                 If hojaWorkday.Cells(i, "A").Value = " " Or IsEmpty(hojaWorkday.Cells(i, "A").Value) Then
                 Else
                    hojaWorkday.Rows(i).Copy sheetMacro.Rows(nextRowRehire)
                    nextRowRehire = nextRowRehire + 1
                 End If
                 Next i
            End If
...
Function validarCorreo(d As Long, nombreReporte As String) As Boolean
    ...
    emailReporte = hojaReporte.Cells(d, "Q").Value
